...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header"><small>2.商品代金、輸送料、送金手数料 確認</small>
            </h1>
            <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-lg-12">
            <form class="form-horizontal" method="post" href="charge_fee_confirm.php">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" name="shipping_fee" placeholder="Shippinp fee">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="item_currency" placeholder="Shipping fee Currency">
                    </div>
                </div>
